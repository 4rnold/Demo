...
public class CodeGenerator {
    ...
    private final static String APP_PROPERTY = "CodeGenerator.properties";
    private final static String AUTHOR = "ARNOLD";
    private final static String BASE_PACKAGE = "com.arnold.febs";
