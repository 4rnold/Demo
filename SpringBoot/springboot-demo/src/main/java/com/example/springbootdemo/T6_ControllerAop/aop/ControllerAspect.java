package com.example.springbootdemo.T6_ControllerAop.aop;

import com.example.springbootdemo.T6_ControllerAop.beans.ResultBean;
import com.example.springbootdemo.T6_ControllerAop.exceptions.CheckException;
import com.example.springbootdemo.T6_ControllerAop.exceptions.UnloginException;
...
public class ControllerAspect {
    ...
    @Pointcut("execution(public * com.example.springbootdemo.T6_ControllerAop.controller.*.*(..))")
